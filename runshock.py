...
solutions, Jrad, vshock, Frad = main.shock_main(sizex=3e10, numpoints=5e3,
    nspecs=ngas, ndust=ndust, v0=vshock, niter=2500, ncpu=4,
...
ax1 = ax0.twinx()
ax1.plot(x0, np.log10(sols['radiation'][:,1]+1e-10), 'g-', lw=1.2, ms=5)
ax1.plot(x0, np.log10(np.abs(sols['radiation'][:,2])+1e-10),
    'r--', lw=1.2, ms=5)
ax1 = fig_labs(ax=ax1, xlab=r'\textbf{\boldmath$t$ [h]}',
